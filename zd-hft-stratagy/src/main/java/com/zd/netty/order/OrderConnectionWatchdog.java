...
public abstract class OrderConnectionWatchdog extends ChannelInboundHandlerAdapter
		implements TimerTask, OrderChannelHandlerHolder {
	...
	public OrderConnectionWatchdog(Bootstrap boot, Timer timert, String host, int port) {
		this.bootstrap = boot;
		this.timer = timert;
		this.host = host;
		this.port = port;
