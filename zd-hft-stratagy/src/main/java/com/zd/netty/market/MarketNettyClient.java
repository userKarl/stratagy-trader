...
@Component
public class MarketNettyClient {
	
	private final static  Logger logger = LoggerFactory.getLogger(MarketNettyClient.class);
	...
	public void start(String host, int port)  {
		...
		final MarketConnectionWatchdog watchDog = new MarketConnectionWatchdog(bootstrap, new HashedWheelTimer(), host, port) {
