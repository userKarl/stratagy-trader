...
public class TraderRef {
	...
	private String orderMarketFlag = "";// 是否被动腿再下单标记，用于手动选择的立即追单
	private String orderMarketReason="";//被动腿下单的原因（自动追单或系统追单中的立即追单）
	...
	public String MyToString() {
		return String.join("^",
				Lists.newArrayList(this.handlerStratagyThreadId, this.stratagyId, this.arbitrageOrderId,
						this.contractOrderId, this.traderSymbolType, this.activeDealId, this.evenActiveFlag,
						this.orderMarketFlag));
	}
}
