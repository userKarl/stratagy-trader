...
public class Trade implements Serializable {
	...
	public String MyToString() {
		...
		this.rtTradeID = "";
		return String.join("@",
				Lists.newArrayList(this.gatewayID, this.symbol, this.exchange, this.rtSymbol, this.tradeID,
						this.rtTradeID, this.orderID, this.rtOrderID, this.direction, this.offset,
						String.valueOf(this.price), String.valueOf(this.volume), this.tradingDay, this.tradeDate,
						this.tradeTime));
	}
