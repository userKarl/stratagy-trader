...
public abstract class GatewayAbstract implements Gateway {
	...
	@Override
	public void emitTick(String gatewayID, String symbol, String exchange, String rtSymbol, String tradingDay,
		...
		try {
			FastEvent fastEvent = ringBuffer.get(sequence); // Get the entry in the Disruptor for the sequence
			fastEvent.getTick().setAllValue(gatewayID, symbol, exchange, rtSymbol, tradingDay, actionDay, actionTime,
					...
					bidPrice3, bidPrice4, bidPrice5, bidPrice6, bidPrice7, bidPrice8, bidPrice9, bidPrice10, askPrice1,
					askPrice2, askPrice3, askPrice4, askPrice5, askPrice6, askPrice7, askPrice8, askPrice9, askPrice10,
					bidVolume1, bidVolume2, bidVolume3, bidVolume4, bidVolume5, bidVolume6, bidVolume7, bidVolume8,
					bidVolume9, bidVolume10, askVolume1, askVolume2, askVolume3, askVolume4, askVolume5, askVolume6,
					askVolume7, askVolume8, askVolume9, askVolume10);
	...
	@Override
	public void emitTrade(String gatewayID, String symbol, String exchange, String rtSymbol, String tradeID,
			String rtTradeID, String orderID, String rtOrderID, String direction, String offset, double price,
		...
		try {
			FastEvent fastEvent = ringBuffer.get(sequence); // Get the entry in the Disruptor for the sequence
			fastEvent.getTrade().setAllValue(gatewayID, symbol, exchange, rtSymbol, tradeID, rtTradeID, orderID,
					rtOrderID, direction, offset, price, volume, tradingDay, tradeDate, tradeTime, dateTime);
	...
	public void emitOrder(String gatewayID, String symbol, String exchange, String rtSymbol, String orderID,
		...
		try {
			FastEvent fastEvent = ringBuffer.get(sequence); // Get the entry in the Disruptor for the sequence
			fastEvent.getOrder().setAllValue(gatewayID, symbol, exchange, rtSymbol, orderID, rtOrderID, direction,
					offset, price, totalVolume, tradedVolume, status, tradingDay, orderDate, orderTime, cancelTime,
					activeTime, updateTime, frontID, sessionID,orderSysId);
