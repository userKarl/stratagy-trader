...
public class LocalPositionDetail implements Serializable {
	...
	public LocalPositionDetail(String gatewayID, String gatewayDisplayName, String exchange, String rtSymbol,
			String symbol, String contractName, int contractSize) {
